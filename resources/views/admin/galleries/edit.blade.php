        ...
        <div class="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
            ...
            <div>
                ...
                <p class="text-blue-100 mt-2 max-w-2xl">
                    Perbarui dokumentasi kegiatan Desa Sidorejo, mulai dari judul, deskripsi, foto, urutan tampil, hingga status.
                </p>
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="mt-5">
                            ...
                            <textarea name="description"
                                      rows="6"
                                      class="w-full resize-y border border-slate-300 rounded-xl px-4 py-3 leading-relaxed outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">{{ old('description', $gallery->description) }}</textarea>
                            ...
                            <label class="flex items-start gap-3 cursor-pointer bg-slate-50 border border-slate-200 rounded-2xl p-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-1">
                                        Nonaktifkan jika foto tidak ingin ditampilkan di halaman publik.
                                    </p>
                ...
                <div class="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden sticky top-6">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-xs text-slate-400 mt-3">
                            Klik foto untuk mengganti. Biarkan kosong jika foto lama tetap digunakan.
                        </p>
