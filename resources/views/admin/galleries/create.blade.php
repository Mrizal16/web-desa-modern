        ...
        <div class="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
            ...
            <div>
                ...
                <p class="text-blue-100 mt-2 max-w-2xl">
                    Tambahkan dokumentasi foto kegiatan Desa Sidorejo untuk ditampilkan di website.
                </p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-400 mt-0.5">
                                    Lengkapi informasi foto yang akan ditampilkan.
                                </p>
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('title') }}"
                                   required
                                   placeholder="Contoh: Kegiatan Kerja Bakti"
                        ...
                        <div class="mt-5">
                            ...
                            <textarea name="description"
                                      rows="6"
                                      placeholder="Deskripsi kegiatan atau foto..."
                                      class="w-full resize-y border border-slate-300 rounded-xl px-4 py-3 leading-relaxed outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">{{ old('description') }}</textarea>
                        ...
                        <div class="mt-6">
                            ...
                            <label class="flex items-start gap-3 cursor-pointer bg-slate-50 border border-slate-200 rounded-2xl p-4">
                                ...
                                <input type="checkbox"
                                       ...
                                       class="w-5 h-5 mt-0.5 rounded border-slate-300 text-indigo-600">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-1">
                                        Foto aktif akan ditampilkan pada bagian galeri di homepage.
                                    </p>
            ...
            <div>
                ...
                <div class="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden sticky top-6">
                    ...
                    <div class="p-5">
                        ...
                        <label for="image"
                               class="block border-2 border-dashed border-slate-300 hover:border-indigo-400 rounded-2xl overflow-hidden cursor-pointer transition">
                        ...
                        <div class="mt-5 bg-slate-50 border border-slate-200 rounded-xl p-4">
                            ...
                            <p class="text-sm text-slate-500 leading-relaxed mt-2">
                                Gunakan foto yang jelas dan proporsional agar tampilan galeri di website terlihat lebih rapi.
                            </p>
                        ...
                        <button type="submit"
                                class="w-full inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-5 py-3.5 rounded-xl mt-5 transition">
