                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea name="description"
                                  ...
                                  class="w-full border border-slate-300 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">{{ old('description') }}</textarea>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 mt-0.5">
                                    Foto aktif akan muncul di homepage.
                                </p>
