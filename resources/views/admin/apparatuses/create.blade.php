        ...
        <div class="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
            ...
            <div>
                ...
                <p class="text-blue-100 mt-2 max-w-2xl">
                    Tambahkan perangkat pemerintahan Desa Sidorejo beserta jabatan, foto, urutan tampil, dan statusnya.
                </p>
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="mt-5">
                            ...
                            <p class="text-xs text-slate-400 mt-2">
                                Angka lebih kecil akan tampil lebih dulu. Contoh: Kepala Desa = 1, Sekretaris Desa = 2.
                            </p>
                            ...
                            <label class="flex items-start gap-3 cursor-pointer bg-slate-50 border border-slate-200 rounded-2xl p-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-1">
                                        Nonaktifkan jika data aparatur belum ingin ditampilkan di halaman publik.
                                    </p>
                    ...
                    <div class="p-5">
                        ...
                        <label for="photo"
                            ...
                            <div id="photoPlaceholder"
                                ...
                                <p class="text-xs text-slate-400 mt-1">
                                    Klik untuk memilih foto aparatur
                                </p>
                        ...
                        <div class="mt-5 bg-slate-50 border border-slate-200 rounded-xl p-4">
                            ...
                            <p class="text-sm text-slate-500 leading-relaxed mt-2">
                                Gunakan foto potret yang jelas agar tampilan aparatur di website lebih rapi.
                            </p>
