        ...
        <div class="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
            ...
            <div>
                ...
                <p class="text-blue-100 mt-2 max-w-2xl">
                    Perbarui isi dan status pengumuman Desa Sidorejo.
                </p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-400 mt-0.5">
                                    Perbarui judul dan isi pengumuman.
                                </p>
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-5 bg-slate-50 border border-slate-200 rounded-xl p-4">
                            ...
                            @else
                                ...
                                <div class="inline-flex items-center gap-2 mt-2 bg-amber-50 text-amber-700 border border-amber-200 text-xs font-semibold px-3 py-1.5 rounded-full">
