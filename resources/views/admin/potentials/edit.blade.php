                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea name="description"
                                  rows="5"
                                  class="w-full border border-slate-300 rounded-xl px-4 py-3 outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">{{ old('description', $potential->description) }}</textarea>
