...
<div class="max-w-5xl mx-auto py-8 px-4 sm:px-6">
        ...
        <div class="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
            ...
            <div>
                ...
                <p class="text-blue-100 mt-2 max-w-2xl">
                    Perbarui nama, deskripsi, gambar, urutan tampil, dan status potensi Desa Sidorejo.
                </p>
    ...
    <form action="{{ route('admin.potentials.update', $potential) }}"
          method="POST"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-400 mt-0.5">
                                    Perbarui informasi utama potensi desa.
                                </p>
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="mt-5">
                            ...
                            <textarea name="description"
                                      rows="6"
                                      class="w-full resize-y border border-slate-300 rounded-xl px-4 py-3 leading-relaxed outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">{{ old('description', $potential->description) }}</textarea>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="number"
                                   name="sort_order"
                                   value="{{ old('sort_order', $potential->sort_order) }}"
                                   min="0"
                                   class="w-full border border-slate-300 rounded-xl px-4 py-3 outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                        ...
                        <div class="mt-6">
                            ...
                            <label class="flex items-start gap-3 cursor-pointer bg-slate-50 border border-slate-200 rounded-2xl p-4">
                                ...
                                <input type="checkbox"
                                       name="is_active"
                                       value="1"
                                       {{ old('is_active', $potential->is_active) ? 'checked' : '' }}
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-1">
                                        Nonaktifkan jika potensi belum ingin ditampilkan di halaman publik.
                                    </p>
                    ...
                    <div class="p-5">
                        ...
                        <label for="image"
                            ...
                            @if($potential->image)
                                ...
                                <img id="imagePreview"
                                     src="{{ asset('storage/' . $potential->image) }}"
                                     alt="{{ $potential->title }}"
                                     class="w-full aspect-square object-cover">

                                <div id="imagePlaceholder"
                                     class="hidden py-14 px-4 text-center">
